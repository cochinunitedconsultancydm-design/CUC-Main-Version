...
class DealStageHistory extends amplify_core.Model {
  ...
  DealStageHistoryModelIdentifier get modelIdentifier {
    return DealStageHistoryModelIdentifier(id: id);
  }
  ...
  const DealStageHistory._internal({
    required this.id,
    deal_id,
    from_stage,
    to_stage,
  ...
  String toString() {
    ...
    buffer.write(
      "changed_by=" +
          (_changed_by != null ? _changed_by!.toString() : "null") +
          ", ",
    );
  ...
  static final amplify_core.QueryModelIdentifier<
    DealStageHistoryModelIdentifier
  >
  MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<DealStageHistoryModelIdentifier>();
...
class _DealStageHistoryModelType
    extends amplify_core.ModelType<DealStageHistory> {
 ...
 */
class DealStageHistoryModelIdentifier
    implements amplify_core.ModelIdentifier<DealStageHistory> {
  final String id;

  /** Create an instance of DealStageHistoryModelIdentifier using [id] the primary key. */
  const DealStageHistoryModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is DealStageHistoryModelIdentifier && id == other.id;
  }
