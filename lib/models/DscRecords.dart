...
class DscRecords extends amplify_core.Model {
  ...
  DscRecordsModelIdentifier get modelIdentifier {
    return DscRecordsModelIdentifier(id: id);
  }
  ...
  const DscRecords._internal({
    ...
    updatedAt,
       ...
       _email_id = email_id,
       _phone_no = phone_no,
       _dsc_taken_date = dsc_taken_date,
       _dsc_expiry_date = dsc_expiry_date,
  ...
  factory DscRecords({
    ...
    String? email_id,
    String? phone_no,
    String? dsc_taken_date,
    String? dsc_expiry_date,
    String? created_at,
    String? updated_at,
  }) {
  ...
  DscRecords copyWithModelFieldValues({
    ...
    return DscRecords._internal(
      ...
      dsc_taken_date: dsc_taken_date == null
          ? this.dsc_taken_date
          : dsc_taken_date.value,
      dsc_expiry_date: dsc_expiry_date == null
          ? this.dsc_expiry_date
          : dsc_expiry_date.value,
  ...
  static final amplify_core.QueryModelIdentifier<DscRecordsModelIdentifier>
  MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<DscRecordsModelIdentifier>();
  ...
  static final DSC_TAKEN_DATE = amplify_core.QueryField(
    fieldName: "dsc_taken_date",
  );
  static final DSC_EXPIRY_DATE = amplify_core.QueryField(
    fieldName: "dsc_expiry_date",
  );
 ...
 */
class DscRecordsModelIdentifier
    implements amplify_core.ModelIdentifier<DscRecords> {
  final String id;

  /** Create an instance of DscRecordsModelIdentifier using [id] the primary key. */
  const DscRecordsModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is DscRecordsModelIdentifier && id == other.id;
  }
