...
class DealActivities extends amplify_core.Model {
  ...
  DealActivitiesModelIdentifier get modelIdentifier {
    return DealActivitiesModelIdentifier(id: id);
  }
  ...
  const DealActivities._internal({
    required this.id,
    deal_id,
    type,
    title,
  ...
  String toString() {
    ...
    buffer.write(
      "is_completed=" +
          (_is_completed != null ? _is_completed!.toString() : "null") +
          ", ",
    );
    buffer.write(
      "created_by=" +
          (_created_by != null ? _created_by!.toString() : "null") +
          ", ",
    );
  ...
  static final amplify_core.QueryModelIdentifier<DealActivitiesModelIdentifier>
  MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<DealActivitiesModelIdentifier>();
  ...
  static final IS_COMPLETED = amplify_core.QueryField(
 ...
 */
class DealActivitiesModelIdentifier
    implements amplify_core.ModelIdentifier<DealActivities> {
  final String id;

  /** Create an instance of DealActivitiesModelIdentifier using [id] the primary key. */
  const DealActivitiesModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is DealActivitiesModelIdentifier && id == other.id;
  }
