...
class LicenseNotifications extends amplify_core.Model {
  ...
  LicenseNotificationsModelIdentifier get modelIdentifier {
    return LicenseNotificationsModelIdentifier(id: id);
  }
  ...
  const LicenseNotifications._internal({
    required this.id,
    client_license_id,
    notification_type,
    message,
  ...
  String toString() {
    ...
    buffer.write(
      "is_sent=" + (_is_sent != null ? _is_sent!.toString() : "null") + ", ",
    );
  ...
  static final amplify_core.QueryModelIdentifier<
    LicenseNotificationsModelIdentifier
  >
  MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<LicenseNotificationsModelIdentifier>();
  static final ID = amplify_core.QueryField(fieldName: "id");
  static final CLIENT_LICENSE_ID = amplify_core.QueryField(
    fieldName: "client_license_id",
  );
  static final NOTIFICATION_TYPE = amplify_core.QueryField(
  ...
  static final SCHEDULED_DATE = amplify_core.QueryField(
...
class _LicenseNotificationsModelType
    extends amplify_core.ModelType<LicenseNotifications> {
 ...
 */
class LicenseNotificationsModelIdentifier
    implements amplify_core.ModelIdentifier<LicenseNotifications> {
  final String id;

  /** Create an instance of LicenseNotificationsModelIdentifier using [id] the primary key. */
  const LicenseNotificationsModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is LicenseNotificationsModelIdentifier && id == other.id;
  }
