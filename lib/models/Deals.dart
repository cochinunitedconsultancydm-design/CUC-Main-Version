...
class Deals extends amplify_core.Model {
  ...
  Deals.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _amount = safeParseDouble(json['amount']),
      ...
      _is_won = safeParseBool(json['is_won']),
      ...
      _est_amount_work = safeParseDouble(json['est_amount_work']),
      _create_invoice_share = json['create_invoice_share'],
      _expense_spent = safeParseDouble(json['expense_spent']),
      _upload_invoice_path = json['upload_invoice_path'],
      _send_to_customer = json['send_to_customer'],
      _register_no = json['register_no'],
      _invoice_amount = safeParseDouble(json['invoice_amount']),
      _payment_type = json['payment_type'],
      _drive_link = json['drive_link'],
      _billing_id = safeParseInt(json['billing_id']),
      _quotation_id = safeParseInt(json['quotation_id']),
      _payment_received = safeParseDouble(json['payment_received']),
      _part_payment_amount = safeParseDouble(json['part_payment_amount']),
      _noc_obtained = safeParseBool(json['noc_obtained']),
