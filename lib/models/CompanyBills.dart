...
class CompanyBills extends amplify_core.Model {
  ...
  CompanyBillsModelIdentifier get modelIdentifier {
    return CompanyBillsModelIdentifier(id: id);
  }
  ...
  const CompanyBills._internal({
    ...
    updatedAt,
       ...
       _spent_by = spent_by,
       _spent_by_name = spent_by_name,
       _createdAt = createdAt,
       _updatedAt = updatedAt;

  factory CompanyBills({
    String? id,
    String? category,
    String? title,
    double? amount,
  ...
  String toString() {
    ...
    buffer.write(
      "spent_by=" + (_spent_by != null ? _spent_by!.toString() : "null") + ", ",
    );
  ...
  CompanyBills copyWithModelFieldValues({
    ...
    return CompanyBills._internal(
      ...
      spent_by_name: spent_by_name == null
          ? this.spent_by_name
          : spent_by_name.value,
    );
  }
  ...
  static final amplify_core.QueryModelIdentifier<CompanyBillsModelIdentifier>
  MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<CompanyBillsModelIdentifier>();
  ...
  static final SPENT_BY_NAME = amplify_core.QueryField(
    fieldName: "spent_by_name",
  );
 ...
 */
class CompanyBillsModelIdentifier
    implements amplify_core.ModelIdentifier<CompanyBills> {
  final String id;

  /** Create an instance of CompanyBillsModelIdentifier using [id] the primary key. */
  const CompanyBillsModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is CompanyBillsModelIdentifier && id == other.id;
  }
