...
class Deals extends amplify_core.Model {
  ...
  DealsModelIdentifier get modelIdentifier {
    return DealsModelIdentifier(id: id);
  }
  ...
  const Deals._internal({
    ...
    updatedAt,
       ...
       _responsible_name = responsible_name,
       _amount = amount,
       _currency = currency,
       _pipeline = pipeline,
       _priority = priority,
       ...
       _is_won = is_won,
       _reg_fee_required = reg_fee_required,
       _files_received = files_received,
       _contact_status = contact_status,
       _files_asked = files_asked,
       _est_amount_work = est_amount_work,
       _create_invoice_share = create_invoice_share,
       _expense_spent = expense_spent,
       _upload_invoice_path = upload_invoice_path,
       _send_to_customer = send_to_customer,
       _register_no = register_no,
       _invoice_amount = invoice_amount,
       _payment_type = payment_type,
       _drive_link = drive_link,
       _billing_id = billing_id,
       _quotation_id = quotation_id,
       _payment_received = payment_received,
       _part_payment_amount = part_payment_amount,
       _noc_obtained = noc_obtained,
       _referred_by = referred_by,
       _expenses_list = expenses_list,
  ...
  factory Deals({
    ...
    String? closed_at,
    bool? is_won,
    String? reg_fee_required,
    String? files_received,
    String? contact_status,
    String? files_asked,
    double? est_amount_work,
    String? create_invoice_share,
    double? expense_spent,
    String? upload_invoice_path,
    String? send_to_customer,
    String? register_no,
  ...
  String toString() {
    ...
    buffer.write(
      "responsible_id=" +
          (_responsible_id != null ? _responsible_id!.toString() : "null") +
          ", ",
    );
    ...
    buffer.write(
      "is_won=" + (_is_won != null ? _is_won!.toString() : "null") + ", ",
    );
    ...
    buffer.write(
      "est_amount_work=" +
          (_est_amount_work != null ? _est_amount_work!.toString() : "null") +
          ", ",
    );
    buffer.write("create_invoice_share=" + "$_create_invoice_share" + ", ");
    buffer.write(
      "expense_spent=" +
          (_expense_spent != null ? _expense_spent!.toString() : "null") +
          ", ",
    );
    ...
    buffer.write(
      "invoice_amount=" +
          (_invoice_amount != null ? _invoice_amount!.toString() : "null") +
          ", ",
    );
    ...
    buffer.write(
      "billing_id=" +
          (_billing_id != null ? _billing_id!.toString() : "null") +
          ", ",
    );
    buffer.write(
      "quotation_id=" +
          (_quotation_id != null ? _quotation_id!.toString() : "null") +
          ", ",
    );
    buffer.write(
      "payment_received=" +
          (_payment_received != null ? _payment_received!.toString() : "null") +
          ", ",
    );
    buffer.write(
      "part_payment_amount=" +
          (_part_payment_amount != null
              ? _part_payment_amount!.toString()
              : "null") +
          ", ",
    );
    buffer.write(
      "noc_obtained=" +
          (_noc_obtained != null ? _noc_obtained!.toString() : "null") +
          ", ",
    );
  ...
  Deals copyWithModelFieldValues({
    ...
    return Deals._internal(
      ...
      reg_fee_required: reg_fee_required == null
          ? this.reg_fee_required
          : reg_fee_required.value,
      files_received: files_received == null
          ? this.files_received
          : files_received.value,
      contact_status: contact_status == null
          ? this.contact_status
          : contact_status.value,
      files_asked: files_asked == null ? this.files_asked : files_asked.value,
      est_amount_work: est_amount_work == null
          ? this.est_amount_work
          : est_amount_work.value,
      create_invoice_share: create_invoice_share == null
          ? this.create_invoice_share
          : create_invoice_share.value,
      expense_spent: expense_spent == null
          ? this.expense_spent
          : expense_spent.value,
      upload_invoice_path: upload_invoice_path == null
          ? this.upload_invoice_path
          : upload_invoice_path.value,
      send_to_customer: send_to_customer == null
          ? this.send_to_customer
          : send_to_customer.value,
      ...
      part_payment_amount: part_payment_amount == null
          ? this.part_payment_amount
          : part_payment_amount.value,
      noc_obtained: noc_obtained == null
          ? this.noc_obtained
          : noc_obtained.value,
      referred_by: referred_by == null ? this.referred_by : referred_by.value,
      expenses_list: expenses_list == null
          ? this.expenses_list
          : expenses_list.value,
    );
  }
  ...
  static final amplify_core.QueryModelIdentifier<DealsModelIdentifier>
  MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<DealsModelIdentifier>();
  ...
  static final CONTACT_INFO = amplify_core.QueryField(
  ...
  static final RESPONSIBLE_ID = amplify_core.QueryField(
    fieldName: "responsible_id",
  );
  static final RESPONSIBLE_NAME = amplify_core.QueryField(
  ...
  static final REG_FEE_REQUIRED = amplify_core.QueryField(
    fieldName: "reg_fee_required",
  );
  static final FILES_RECEIVED = amplify_core.QueryField(
    fieldName: "files_received",
  );
  static final CONTACT_STATUS = amplify_core.QueryField(
    fieldName: "contact_status",
  );
  static final FILES_ASKED = amplify_core.QueryField(fieldName: "files_asked");
  static final EST_AMOUNT_WORK = amplify_core.QueryField(
    fieldName: "est_amount_work",
  );
  static final CREATE_INVOICE_SHARE = amplify_core.QueryField(
    fieldName: "create_invoice_share",
  );
  static final EXPENSE_SPENT = amplify_core.QueryField(
    fieldName: "expense_spent",
  );
  static final UPLOAD_INVOICE_PATH = amplify_core.QueryField(
    fieldName: "upload_invoice_path",
  );
  static final SEND_TO_CUSTOMER = amplify_core.QueryField(
    fieldName: "send_to_customer",
  );
  static final REGISTER_NO = amplify_core.QueryField(fieldName: "register_no");
  static final INVOICE_AMOUNT = amplify_core.QueryField(
    fieldName: "invoice_amount",
  );
  static final PAYMENT_TYPE = amplify_core.QueryField(
  ...
  static final QUOTATION_ID = amplify_core.QueryField(
    fieldName: "quotation_id",
  );
  static final PAYMENT_RECEIVED = amplify_core.QueryField(
    fieldName: "payment_received",
  );
  static final PART_PAYMENT_AMOUNT = amplify_core.QueryField(
    fieldName: "part_payment_amount",
  );
  static final NOC_OBTAINED = amplify_core.QueryField(
    fieldName: "noc_obtained",
  );
  static final REFERRED_BY = amplify_core.QueryField(fieldName: "referred_by");
  static final EXPENSES_LIST = amplify_core.QueryField(
    fieldName: "expenses_list",
  );
...
class DealsModelIdentifier implements amplify_core.ModelIdentifier<Deals> {
  ...
  const DealsModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is DealsModelIdentifier && id == other.id;
  }
