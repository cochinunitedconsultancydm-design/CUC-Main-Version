  ...
  Widget _buildLicenseCard(ClientLicense l, bool isWide) {
    ...
    return Card(
      ...
      child: ExpansionTile(
        ...
        subtitle: Text(
          'File: ${l.fileNo ?? "N/A"} ΓÇó ${l.licenseTypeName ?? "License"}', 
        ...
        children: [
          ...
          if (billings.isEmpty)
            ...
            ...billings.map((b) => ListTile(
              ...
              title: Text('Γé╣${b.amount}', style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
              subtitle: Text('${b.invoiceNo ?? "No Invoice"} ΓÇó ${b.paymentDate != null ? DateFormat('dd/MM/yyyy').format(b.paymentDate!) : ""}', style: const TextStyle(fontSize: 11)),
              trailing: Container(
        ...
        builder: (context, setModalState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              TextField(
                controller: amount, 
                decoration: const InputDecoration(labelText: 'Amount (Γé╣)', prefixIcon: Icon(Icons.currency_rupee_rounded)), 
