...
class Notifications extends amplify_core.Model {
  ...
  const Notifications._internal({required this.id, user_id, title, message, type, is_read, created_at, deal_id, task_id, createdAt, updatedAt}): _user_id = user_id, _title = title, _message = message, _type = type, _is_read = is_read, _created_at = created_at, _deal_id = deal_id, _task_id = task_id, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Notifications({String? id, int? user_id, String? title, String? message, String? type, bool? is_read, String? created_at, int? deal_id, int? task_id}) {
  ...
  Notifications copyWith({int? user_id, String? title, String? message, String? type, bool? is_read, String? created_at, int? deal_id, int? task_id}) {
    return Notifications._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'user_id': _user_id, 'title': _title, 'message': _message, 'type': _type, 'is_read': _is_read, 'created_at': _created_at, 'deal_id': _deal_id, 'task_id': _task_id, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
