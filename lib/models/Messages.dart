...
class Messages extends amplify_core.Model {
  ...
  const Messages._internal({required this.id, sender_id, receiver_id, content, is_read, created_at, attachment_type, attachment_id, createdAt, updatedAt}): _sender_id = sender_id, _receiver_id = receiver_id, _content = content, _is_read = is_read, _created_at = created_at, _attachment_type = attachment_type, _attachment_id = attachment_id, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Messages({String? id, int? sender_id, int? receiver_id, String? content, bool? is_read, String? created_at, String? attachment_type, int? attachment_id}) {
  ...
  Messages copyWith({int? sender_id, int? receiver_id, String? content, bool? is_read, String? created_at, String? attachment_type, int? attachment_id}) {
    return Messages._internal(
      id: id,
  ...
  Messages copyWithModelFieldValues({
    ...
    return Messages._internal(
      ...
      attachment_type: attachment_type == null ? this.attachment_type : attachment_type.value,
      attachment_id: attachment_id == null ? this.attachment_id : attachment_id.value
    );
  }
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'sender_id': _sender_id, 'receiver_id': _receiver_id, 'content': _content, 'is_read': _is_read, 'created_at': _created_at, 'attachment_type': _attachment_type, 'attachment_id': _attachment_id, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final ATTACHMENT_TYPE = amplify_core.QueryField(fieldName: "attachment_type");
  static final ATTACHMENT_ID = amplify_core.QueryField(fieldName: "attachment_id");
