...
class ClientDocuments extends amplify_core.Model {
  ...
  const ClientDocuments._internal({required this.id, client_id, client_name, document_name, storage_path, og_copy, remarks, created_at, verification_status, rejection_reason, createdAt, updatedAt}): _client_id = client_id, _client_name = client_name, _document_name = document_name, _storage_path = storage_path, _og_copy = og_copy, _remarks = remarks, _created_at = created_at, _verification_status = verification_status, _rejection_reason = rejection_reason, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory ClientDocuments({String? id, String? client_id, String? client_name, String? document_name, String? storage_path, String? og_copy, String? remarks, String? created_at, String? verification_status, String? rejection_reason}) {
  ...
  ClientDocuments copyWith({String? client_id, String? client_name, String? document_name, String? storage_path, String? og_copy, String? remarks, String? created_at, String? verification_status, String? rejection_reason}) {
    return ClientDocuments._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'client_id': _client_id, 'client_name': _client_name, 'document_name': _document_name, 'storage_path': _storage_path, 'og_copy': _og_copy, 'remarks': _remarks, 'created_at': _created_at, 'verification_status': _verification_status, 'rejection_reason': _rejection_reason, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final VERIFICATION_STATUS = amplify_core.QueryField(fieldName: "verification_status");
  static final REJECTION_REASON = amplify_core.QueryField(fieldName: "rejection_reason");
