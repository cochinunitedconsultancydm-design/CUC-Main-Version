...
class Checklists extends amplify_core.Model {
  ...
  ChecklistsModelIdentifier get modelIdentifier {
    return ChecklistsModelIdentifier(id: id);
  }
  ...
  String toString() {
    ...
    buffer.write(
      "manager_id=" +
          (_manager_id != null ? _manager_id!.toString() : "null") +
          ", ",
    );
    buffer.write(
      "responsible_id=" +
  ...
  static final amplify_core.QueryModelIdentifier<ChecklistsModelIdentifier>
  MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<ChecklistsModelIdentifier>();
 ...
 */
class ChecklistsModelIdentifier
    implements amplify_core.ModelIdentifier<Checklists> {
  final String id;

  /** Create an instance of ChecklistsModelIdentifier using [id] the primary key. */
  const ChecklistsModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is ChecklistsModelIdentifier && id == other.id;
  }
