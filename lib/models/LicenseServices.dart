...
class LicenseServices extends amplify_core.Model {
  ...
  LicenseServicesModelIdentifier get modelIdentifier {
      return LicenseServicesModelIdentifier(
        id: id
      );
  }
  ...
  const LicenseServices._internal({required this.id, client_license_id, service_description, service_cost, service_date, created_at, createdAt, updatedAt}): _client_license_id = client_license_id, _service_description = service_description, _service_cost = service_cost, _service_date = service_date, _created_at = created_at, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory LicenseServices({String? id, int? client_license_id, String? service_description, double? service_cost, String? service_date, String? created_at}) {
  ...
  LicenseServices copyWith({int? client_license_id, String? service_description, double? service_cost, String? service_date, String? created_at}) {
    return LicenseServices._internal(
      id: id,
  ...
  LicenseServices copyWithModelFieldValues({
    ...
    return LicenseServices._internal(
      ...
      service_description: service_description == null ? this.service_description : service_description.value,
      service_cost: service_cost == null ? this.service_cost : service_cost.value,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'client_license_id': _client_license_id, 'service_description': _service_description, 'service_cost': _service_cost, 'service_date': _service_date, 'created_at': _created_at, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<LicenseServicesModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<LicenseServicesModelIdentifier>();
  static final ID = amplify_core.QueryField(fieldName: "id");
  static final CLIENT_LICENSE_ID = amplify_core.QueryField(fieldName: "client_license_id");
  static final SERVICE_DESCRIPTION = amplify_core.QueryField(fieldName: "service_description");
  static final SERVICE_COST = amplify_core.QueryField(fieldName: "service_cost");
...
class _LicenseServicesModelType extends amplify_core.ModelType<LicenseServices> {
 ...
 */
class LicenseServicesModelIdentifier implements amplify_core.ModelIdentifier<LicenseServices> {
  final String id;

  /** Create an instance of LicenseServicesModelIdentifier using [id] the primary key. */
  const LicenseServicesModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is LicenseServicesModelIdentifier &&
      id == other.id;
  }
