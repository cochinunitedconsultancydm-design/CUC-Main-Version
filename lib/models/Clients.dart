...
class Clients extends amplify_core.Model {
  ...
  ClientsModelIdentifier get modelIdentifier {
    return ClientsModelIdentifier(id: id);
  }
  ...
  String toString() {
    ...
    buffer.write(
      "review_rating=" +
          (_review_rating != null ? _review_rating!.toString() : "null") +
          ", ",
    );
    ...
    buffer.write(
      "is_contacted=" +
          (_is_contacted != null ? _is_contacted!.toString() : "null") +
          ", ",
    );
  ...
  Clients copyWithModelFieldValues({
    ...
    return Clients._internal(
      ...
      is_contacted: is_contacted == null
          ? this.is_contacted
          : is_contacted.value,
  ...
  static final amplify_core.QueryModelIdentifier<ClientsModelIdentifier>
  MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<ClientsModelIdentifier>();
  ...
  static final TYPE_OF_WORK = amplify_core.QueryField(
  ...
  static final REVIEW_RATING = amplify_core.QueryField(
  ...
  static final IS_CONTACTED = amplify_core.QueryField(
...
class ClientsModelIdentifier implements amplify_core.ModelIdentifier<Clients> {
  ...
  const ClientsModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is ClientsModelIdentifier && id == other.id;
  }
