...
const schema = a.schema({
  ...
  DscRecords: a.model({
    ...
    created_at: a.string(),
    updated_at: a.string(),
  }).authorization((allow) => [allow.owner(), allow.groups(['Admin']), allow.authenticated().to(['read', 'create', 'update', 'delete'])]),
  ...
  OfficeLocations: a.model({
    id: a.id().required(),
    name: a.string().required(),
    place: a.string().required(),
    location_link: a.string(),
    office_phone_numbers: a.string(),
    front_view_photo: a.string(),
    designation_boards_photos: a.string(),
    notice_boards_photos: a.string(),
    officers_contacts: a.string(),
    other_photos: a.string(),
    created_at: a.string(),
    updated_at: a.string(),
  }).authorization((allow) => [allow.groups(['Admin']), allow.authenticated().to(['read'])]),
  Contacts: a.model({
    ...
    office: a.string(),
    personal_number: a.string(),
    official_number: a.string(),
    email: a.string(),
    place: a.string(),
    native_place: a.string(),
    working_place: a.string(),
    created_at: a.string(),
  }).authorization((allow) => [allow.groups(['Admin']), allow.authenticated().to(['read'])]),
  ...
  Users: a.model({
    ...
    email: a.string(),
    designation: a.string(),
    personal_phone: a.string(),
    aadhar_card: a.string(),
    driving_license: a.string(),
    insurance: a.string(),
    emergency_contact: a.string(),
    offer_letter: a.string(),
    dob: a.string(),
    salary: a.string(),
    work_time: a.string(),
